...
import styles from "./AddReviewerssPopUp.module.css";

const AddReviewerssPopUp = () => {
  ...
  return (
    <div className={styles.addReviewerssPopUp}>
      <img
      ...
      <div className={styles.frameParent2}>
        ...
        <div className={styles.acceptButton3}>
          ...
          <div className={styles.acceptButton4}>
      ...
      <div className={styles.addReviewerssPopUpChild} />
      <div className={styles.addReviewerssPopUpItem} />
    </div>
  );
};

export default AddReviewerssPopUp;
